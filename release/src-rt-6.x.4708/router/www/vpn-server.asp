		...
		<div class="section" id="htmlConf">
			<script type="text/javascript">
				...
				for (i = 0; i < tabs.length; ++i)
				{
					...
					htmlOut += '<input type=\'hidden\' id=\'vpn_'+t+'_plan1\' name=\'vpn_'+t+'_plan1\'>';
					htmlOut += '<input type=\'hidden\' id=\'vpn_'+t+'_plan2\' name=\'vpn_'+t+'_plan2\'>';
					htmlOut += '<input type=\'hidden\' id=\'vpn_'+t+'_plan3\' name=\'vpn_'+t+'_plan3\'>';
					...
					var status = (!eval('vpn'+(i+1)+'up') ? '<small class="text-danger">(Stopped)</small>' : '<small style="color: green;">(Running)</small>');
