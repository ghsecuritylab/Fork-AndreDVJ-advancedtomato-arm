...
<content>
	...
	<script type="text/javascript">
		...
		tabs = [['client1', 'Client 1 <i class="icon-tools"></i>'],['client2', 'Client 2 <i class="icon-tools"></i>'],['client3', 'Client 3 <i class="icon-tools"></i>']];
			...
			for (i = 0; i < tabs.length; ++i) {
				...
				htmlOut += createFormFields([
					...
					{ title: 'Server Address/Port', multi: [
						{ name: 'vpn_'+t+'_addr', type: 'text', size: 40, value: eval( 'nvram.vpn_'+t+'_addr' ) },
